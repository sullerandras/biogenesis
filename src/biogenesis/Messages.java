...
public class Messages {
	 ...
	 */
	private static final String[] supportedLocalesNames = new String[6];
	/**
	 * The standard codes of all supported languages
	 */
	private static final String[] supportedLocalesCodes = {"en","es","ca","de","pt","ru"}; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$
	/**
	...
	protected static void changeLocale() {
		supportedLocalesNames[0] = Messages.getString("T_ENGLISH"); //$NON-NLS-1$
		supportedLocalesNames[1] = Messages.getString("T_SPANISH"); //$NON-NLS-1$
		supportedLocalesNames[2] = Messages.getString("T_CATALAN"); //$NON-NLS-1$
		supportedLocalesNames[3] = Messages.getString("T_GERMAN"); //$NON-NLS-1$
		supportedLocalesNames[4] = Messages.getString("T_PORTUGUESE"); //$NON-NLS-1$
		supportedLocalesNames[5] = Messages.getString("T_RUSSIAN"); //$NON-NLS-1$
	}
}
