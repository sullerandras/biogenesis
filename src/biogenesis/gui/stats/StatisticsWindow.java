...
public class StatisticsWindow extends JDialog {
	...
	private void updateColorPanel(ColorPanel colorPanel) {
		InfoAndColor[] colorCounter = new InfoAndColor[49];
		...
		colorCounter[39] = new InfoAndColor(0, Utils.ColorSPIN);
		colorCounter[40] = new InfoAndColor(0, Color.YELLOW);
		colorCounter[41] = new InfoAndColor(0, Utils.ColorAUBURN);
		colorCounter[42] = new InfoAndColor(0, Utils.ColorINDIGO);
		colorCounter[43] = new InfoAndColor(0, Utils.ColorBLOND);
		colorCounter[44] = new InfoAndColor(0, Utils.ColorFLOWER);
		colorCounter[45] = new InfoAndColor(0, Color.DARK_GRAY);
		colorCounter[46] = new InfoAndColor(0, Utils.ColorGOLD);
		colorCounter[47] = new InfoAndColor(0, Utils.ColorDARK);
		colorCounter[48] = new InfoAndColor(0, Utils.ColorEYE);
