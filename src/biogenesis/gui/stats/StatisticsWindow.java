...
public class StatisticsWindow extends JDialog {
	...
	private void updateColorPanel(ColorPanel colorPanel) {
		InfoAndColor[] colorCounter = new InfoAndColor[50];
		...
		colorCounter[16] = new InfoAndColor(0, Utils.ColorCRIMSON);
		colorCounter[17] = new InfoAndColor(0, Color.PINK);
		colorCounter[18] = new InfoAndColor(0, Utils.ColorCREAM);
		colorCounter[19] = new InfoAndColor(0, Color.LIGHT_GRAY);
		colorCounter[20] = new InfoAndColor(0, Utils.ColorSPIKE);
		colorCounter[21] = new InfoAndColor(0, Utils.ColorLILAC);
		colorCounter[22] = new InfoAndColor(0, Color.GRAY);
		colorCounter[23] = new InfoAndColor(0, Utils.ColorVIOLET);
		colorCounter[24] = new InfoAndColor(0, Utils.ColorOLIVE);
		colorCounter[25] = new InfoAndColor(0, Utils.ColorSKY);
		colorCounter[26] = new InfoAndColor(0, Color.BLUE);
		colorCounter[27] = new InfoAndColor(0, Utils.ColorOCHRE);
		colorCounter[28] = new InfoAndColor(0, Utils.ColorFALLOW);
		colorCounter[29] = new InfoAndColor(0, Utils.ColorSPORE);
		colorCounter[30] = new InfoAndColor(0, Color.WHITE);
		colorCounter[31] = new InfoAndColor(0, Utils.ColorPLAGUE);
		colorCounter[32] = new InfoAndColor(0, Utils.ColorCORAL);
		colorCounter[33] = new InfoAndColor(0, Utils.ColorMINT);
		colorCounter[34] = new InfoAndColor(0, Utils.ColorLAVENDER);
		colorCounter[35] = new InfoAndColor(0, Color.MAGENTA);
		colorCounter[36] = new InfoAndColor(0, Utils.ColorROSE);
		colorCounter[37] = new InfoAndColor(0, Color.CYAN);
		colorCounter[38] = new InfoAndColor(0, Utils.ColorTEAL);
		colorCounter[39] = new InfoAndColor(0, Utils.ColorDRIFT);		
		colorCounter[40] = new InfoAndColor(0, Utils.ColorSPIN);
		colorCounter[41] = new InfoAndColor(0, Color.YELLOW);
		colorCounter[42] = new InfoAndColor(0, Utils.ColorAUBURN);
		colorCounter[43] = new InfoAndColor(0, Utils.ColorINDIGO);
		colorCounter[44] = new InfoAndColor(0, Utils.ColorBLOND);
		colorCounter[45] = new InfoAndColor(0, Utils.ColorFLOWER);
		colorCounter[46] = new InfoAndColor(0, Color.DARK_GRAY);
		colorCounter[47] = new InfoAndColor(0, Utils.ColorGOLD);
		colorCounter[48] = new InfoAndColor(0, Utils.ColorDARK);
		colorCounter[49] = new InfoAndColor(0, Utils.ColorEYE);
